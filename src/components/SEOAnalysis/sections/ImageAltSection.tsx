...
export function ImageAltSection({ status, description, evidence, images }: ImageAltSectionProps) {
    ...
    const stats = (() => {
        try {
            ...
            return { total: 0, withAlt: 0, withoutAlt: 0, percentage: 0 }
        }
    })()
        ...
        <div className="optimization-section">
            ...
            <div className="field-group">
                ...
                <div className="heading-counter-container-summary">
                    <div className="heading-count-container">
                        ...
                        <span className="heading-count-number-container">{stats.total}</span>
                    </div>
                    <div className={`heading-count-container ${stats.withAlt > 0 ? 'pass' : ''}`}>
                        <span className="heading-level-badge-container">WITH ALT</span>
                        <span className="heading-count-number-container">{stats.withAlt}</span>
                    </div>
                    <div className={`heading-count-container ${stats.withoutAlt > 0 ? 'fail' : ''}`}>
                        ...
                        <span className="heading-count-number-container">{stats.withoutAlt}</span>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <ul>
                    ...
                    <li>
                        For an infographic:
                        <span className="good-pill-example">Chart showing website traffic growth from January to December</span>
                    </li>
                    <li>
                        For a team photo:
                ...
                <ul>
                    ...
                    <li>
                        Too verbose:
                        <span className="bad-pill-example">This is a photograph taken at our office showing our team members standing together...</span>
                    </li>
                    <li>
                        Filename as alt:
            ...
            <Accordion 
                title="How to add Alt Text in Framer?"
                icon={<HelpIcon className="help-icon" />}
            >
                <ul>
